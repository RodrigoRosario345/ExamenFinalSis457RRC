...
void AssetManager::load(SDL_Renderer* renderer)
{
    ...
    loadTexture(renderer, GameTexture::EnemyDarkFlash, "assets/enemy_2.png");
    loadTexture(renderer, GameTexture::Enemy1, "assets/enemy_2.png");
    loadTexture(renderer, GameTexture::Enemy2, "assets/enemy_1.png");
