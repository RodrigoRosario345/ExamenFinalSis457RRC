...
private:
    ...
    void spawnEnemy2(GameTexture texture, AIType type, const int positionX, const int positionY);
    ...
    //----------
    void updateEnemies2Collision();
    //------------
    void updateBangsCollision();
    void updateBangs2Collision();
    ...
    std::vector<std::shared_ptr<EnemigoFantasma>> enemiesFantasma;

    //std::vector<Enemy*> enemies;// enemies
/*    std::vector<std::shared_ptr<EnemyDarkFlash>> enemies;   */         // enemies
