...
protected:
   //------------------------
    GameEnemyType tipoEnemy;
//-----------------
public:
    //--------------------------------------------------------------------
    virtual GameEnemyType returnGameEnemyType() = 0 ; //me devuelve el tipo de objeto


    virtual  shared_ptr<Enemy> clone() = 0;
...
public:
    ...
    void setVelocidad(int _attackSpeed) { attackSpeed = _attackSpeed; }
